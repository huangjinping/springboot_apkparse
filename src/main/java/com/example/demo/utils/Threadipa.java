...
public class Threadipa {


    private final ApaParser packageParse;

    public Threadipa(ApaParser packageParse) {
        this.packageParse = packageParse;
    }


    public Map<String, Object> parseIpaData(String outFilePath, String appType) {
