...
public class ThreadSearchP {
    ...
    public Map<String, Object> parseData(String outFilePath) {
            ...
            threadPoolExecutor.execute(new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        List<CommonModel> strings = stringTask.searchLogs(outFilePath, StringTask.getLenIndex(StringTask.SearchLog4, poolLength, index));
        ...
        result.put("searchPath", searchField);
        try {
